# Reviewer kickoff email — Aug 15, 2026

Send **Sat Aug 15, 2026**, immediately after the Aug 14 submission deadline and once chairs have finalized COI-clean assignments.
...
Please read the COI section in the **Reviewer Packet** (https://newenglandcompbio.org/files/reviewer-packet.pdf). If any assigned abstract has a conflict (same institution, recent co-author, advisor/advisee, close collaborator, personal or financial), reply and we'll reassign within 24 hours.
...
## Quick calibration reminders

- **Use the full 1–5 range.** If everything clusters at 3–4 we can't rank.
- **Score against a first-year regional venue**, not the top of the field.
- **Trainee-first is core to NECB** — don't downgrade for early-career polish; do downgrade for weak science.
- **Overall recommendation carries more weight than dimension scores** — use it decisively.

## If you get stuck

Reply to this thread or email `newenglandcompbio@gmail.com`. The organizing committee is on standby.

Thank you again — the meeting depends on this.
